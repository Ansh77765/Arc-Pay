        ...
        <div className="grid gap-16 lg:grid-cols-[1fr_420px] lg:items-start">
          <section className="animate-fade-up">
            ...
            <p className="mt-5 max-w-sm text-[15px] leading-relaxed text-ink-dim">
              Request an exact USDC amount, share a link, and watch it settle
              on-chain — no invoices, no accounts, no middleman. Every payment
              is a direct wallet-to-wallet transfer on Arc Testnet.
            </p>
